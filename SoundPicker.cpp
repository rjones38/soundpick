...
SoundPicker::SoundPicker(const InstanceInfo& info)
...
#if IPLUG_DSP
void SoundPicker::ProcessBlock(sample** inputs, sample** outputs, int nFrames)
{
...
void SoundPicker::OnIdle()
{
  mMeterSender.TransmitData(*this);
  mLFOVisSender.TransmitData(*this);
}

void SoundPicker::OnReset()
{
  mDSP.Reset(GetSampleRate(), GetBlockSize());
}

void SoundPicker::ProcessMidiMsg(const IMidiMsg& msg)
{
  TRACE;
...
void SoundPicker::OnParamChange(int paramIdx)
{
  mDSP.SetParam(paramIdx, GetParam(paramIdx)->Value());
}

bool SoundPicker::OnMessage(int msgTag, int ctrlTag, int dataSize, const void* pData)
{
